...
def main():
    ...
    save_path = Path("videos/mujoco/single_arm/push_medium/ppo_eval_ft.mp4")
    save_path.parent.mkdir(parents=True, exist_ok=True)

    env = MujocoSingleArmPushMediumEnv(render_mode="rgb_array")
    ...
    print("\n=== Render Episode (Fine-tuned Medium Policy) ===")
